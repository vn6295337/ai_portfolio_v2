#!/usr/bin/env python3
"""
Groq Pipeline: Auto-refresh ims.10_model_aa_mapping table
==========================================================

Standalone wrapper for refreshing model-AA mappings for Groq provider.
...
def main():
    """Main execution wrapper for Groq pipeline mapping refresh."""
    print("=" * 70)
    print(f"Groq Pipeline: Model-AA Mapping Refresh")
    print("=" * 70)
